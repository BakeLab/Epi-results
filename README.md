...
Épi is Bake AI’s infrastructure for autonomous research. This collection contains **120 record-setting results across science and engineering: 20 numerical bound records and 100 construction records**, plus **one theorem extension**.

<table>
<tr>
<td width="280" align="center" valign="top"><h2>20</h2>Numerical bound<br>records<br><br></td>
<td width="280" align="center" valign="top"><h2>100</h2>Construction<br>records<br><br></td>
<td width="280" align="center" valign="top"><h2>1</h2>Theorem<br>extension<br><br></td>
</tr>
</table>

The results span **21 problem families**: 12 numerical-bound families, 8 construction families and the Tuza theorem extension.
...
<details>
<summary><strong>Browse 100 construction records across 8 categories</strong></summary>

| Category | Records | Objective |
| :-- | --: | :-- |
...
| [Circles in a semicircle](records/semicircle) | 5 | Larger common radius |
...
| Collection | Files |
| :-- | :-- |
| **120 records + 1 theorem extension** | [Counts and result membership](data/summary.json) |
| **100 construction records** | [CSV index](data/records.csv) · [JSON index](data/records.json) |
